...
for (tech in names(techs.HEK.20K.list)){
    ...
    for (cell in 1:ncol(tech.data)){
      ...
      for (i in 1:100){
        ...
        sample.gene.numbers <- c(sample.gene.numbers, num.uniq.genes)
      }
      print(paste(cell," = ", mean(sample.gene.numbers), sep = ""))
      tech.cumul.gene.numbers <- c(tech.cumul.gene.numbers, mean(sample.gene.numbers))
    }
...
pdf("/project/devel/alafzi/SC_Protocols/Version3/R_analysis/Cumulative_gene/Cumulative_gene_dist_DS20K_HEK.pdf")
...
pdf("/project/devel/alafzi/SC_Protocols/Version3/R_analysis/Cumulative_gene/Cumulative_gene_dist_DS20K_Monocytes.pdf")
