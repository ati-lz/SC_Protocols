...
ggplot(hsap.nread.numi.df, aes(x=nTReads, y=nUMIs, group=tech)) + geom_line(aes(color=tech))+ xlim(0, 100000)# + geom_line(aes(color=tech))#
...
ggplot(hsap.nread.ngene.df, aes(x=nTReads, y=nGenes, group=tech)) + geom_line(aes(color=tech))+ xlim(0, 100000)# + geom_line(aes(color=tech))#
